...
public class DatabaseHelper extends SQLiteOpenHelper {
   ...
   */
  private static String DBPATH = "/data/data/com.example.horariocolina/databases/";

  // Este é o nome do banco de dados que iremos utilizar
  private static String DBNAME ="BANCO.sqlite";
  ...
  public DatabaseHelper(Context context) {
     ...
     */
    super(context, "BANCO.sqlite", null, 1);
  ...
  throws IOException {
    ...
    InputStream dbInputStream = 
      context.getAssets().open("BANCO.sqlite");
